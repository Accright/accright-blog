...
// 原型
    UploadImg.prototype = {
        ...
        insertLinkImg: function insertLinkImg(link) {
            ...
            editor.cmd.do('insertHTML', '<div style="text-align: center;"><img src="' + link + '" style="max-width:100%;"/></div>');
    ...
    Editor.prototype = {
        ...
        _initDom: function _initDom() {
            ...
            if (textSelector == null) {
                ...
                // 自行创建的，需要配置默认的样式
                $toolbarElem.css("border", "1px solid #FF7256").css("border-radius", "15px 4px 0 0").css("border-bottom", "0");
                $textContainerElem.css("border", "1px solid #FF7256").css("border-radius", "0px 0px 15px 0px").css("height", "100%").css("max-height", "115px");
            } else {
